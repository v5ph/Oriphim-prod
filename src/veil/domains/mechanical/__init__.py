...
plugin-discovery system: a caller (currently `veil.cli`) imports this module
...
from veil.domains.mechanical import checks as checks_module
from veil.domains.mechanical import priors as priors_module
from veil.domains.mechanical import solver as solver_module
