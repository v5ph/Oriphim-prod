...
stated it, oriphim inferred it from context, or it was defaulted from a
...
class Provenance(StrEnum):
    ...
    INFERRED = "inferred"
    """oriphim derived it; requires review."""
...
class Provenanced(BaseModel, Generic[T]):
    ...
    """Why oriphim inferred this value. Required in spirit when provenance is INFERRED."""
